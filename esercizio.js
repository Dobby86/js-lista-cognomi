...
var listaCognomi = ["castro", "basso","astotele" , "giletti", "zontana" , + "" + cognomeUtente];


// console.log(listaCognomi);

//variabili aggiuntivi
var itemN , vecchioContenuto ,ordine ;
...
for (var i = 0 ; i < listaCognomi.length ; i++) {
    ...
    function myFunction() {
        listaCognomi.sort;
        document.getElementById("nomignoli").innerHTML = listaCognomi;
    }
